...
function rules_table_element(rule, index) {
    return ' \
        <tr data-toggle="'+(index)+'"> \
            ...
            <td class="starttime"> starts at '+rule.startTime.hour+':'+rule.startTime.minutes+'</td> \
            <td class="endtime"> ends at '+rule.endTime.hour+':'+rule.endTime.minutes+'</td> \
            <td class="closedPerc"> shutters closed at '+rule.closedPercentage+'%</td> \
            <td> \
                <a data-toggle="'+(index)+'" class="small waves-effect waves-red btn-flat removeRule tooltipped right" data-position="bottom" data-delay="50" data-tooltip="Remove Rule"> \
