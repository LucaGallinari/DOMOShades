...
<@layout.mainLayout userNick userEmail logoutURL>
    <div class="container">
                        ...
                        <#list homes as home>
                            <tr>
                                ...
                                <td id="removeHome${home.id}">
                                    <a data-toggle="${home.id}" class="waves-effect waves-red btn-flat removeHome">
                                        <i class="small mdi-action-highlight-remove red-text"></i>
                                    </a>
                                </td>
                            </tr>
                        </#list>
            ...
            <div class="row" style="margin-top: 20px;" id="addHome">
                <h4 class="amber-text">Add a home</h4>
                <form class="col l12" method="post" name>
                    <div class="row">
