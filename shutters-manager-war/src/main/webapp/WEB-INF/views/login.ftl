...
<@layout.mainLayout>
    ...
    <div class="card-action row buttons-row">
        <p><a href="${loginURL}" class="waves-effect waves-light btn-large deep-orange right white-text"><i class="mdi-content-forward left white-text"></i>Start DOMOShades</a></p>
    </div>
</@layout.mainLayout>